...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://files.catbox.moe/payfnr.jpg", caption="» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.\n\n» ɴᴏᴛᴇ:  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("❍ Uff.. 🤪 ● ᴘᴀʜʟᴇ ᴊᴀᴋᴇ ᴋʜᴜᴅ ʙᴏᴛ ʙɴᴀ ʟ#ᴜᴅᴇ", show_alert=True)
    else:
